...
export default function UserRegister() {
  ...
  const handleRegister = () => {
    ...
    if (existingUsers.find((u) => u.username === form.username)) { alert("❌ Username already exists"); return; }
    existingUsers.push({ ...form, role: "user" });
    localStorage.setItem("users", JSON.stringify(existingUsers));
          ...
          {step === 3 && (
            <div className="fade-in">
              ...
              <div className="nav-buttons">
                ...
                <button className="btn-next" disabled={!step3Valid} onClick={handleRegister}>
